    ...
    <body>
        ...
        <div id="page-container" class="boxed">
            ...
            <section class="site-section site-section-top site-section-light themed-background-dark-default">
                <div class="container">
                    <h1 class="text-center animation-fadeInQuickInv" style="color: #8A8A8A;">Cerca <strong style="font-weight: 700;"> Partito/Lista.</strong></h1>
                </div>
            </section>
            <!-- END Intro -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <br><br>
                            ...
                            Cerca il partito, visualizza i voti raccolti, per ogni sezione, nelle precedenti elezioni comunali (2002, 2006, 2011)</p>
...
<input type="text" id="customer_ric1" name="namePartito" class="form-control" placeholder="Cerca Partito/Lista...">
...
<button type="submit" class="btn btn-primary"><i class="fa fa-search"></i></button>
                        ...
                        <div class="col-sm-4 col-sm-pull-8 clearfix push">
