<?php
session_start();
include ("frontend/classes/Mail.php");
function mail_notify_login($id_utente, $lingua, $smtp_host, $smtp_username, $smtp_password){
	...
	$from = "info@mallvill.it";
	$to = "dedrisproject@gmail.com"; 
	$subject = "Mallvill ".$lingua." - ".$nomeutente." - ha effettuato l'accesso da Facebook";
...
FacebookSession::setDefaultApplication( '1475693236070548','b123573fcd81a50197da43c725f32b2e' );
// login helper with redirect_uri
    $helper = new FacebookRedirectLoginHelper('https://'.$_SERVER["HTTP_HOST"].'/fb-login.php' );
try {
